...
<div class="fade-up max-w-5xl mx-auto">
    ...
    <form action="{{ route('admin.articles.update', $article->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="md:col-span-2">
                    ...
                    @if($article->featured_image)
                        <div class="flex items-center gap-4 mb-3">
                            <img src="{{ $article->featured_image_url }}" alt="Ảnh đại diện hiện tại"
                                 class="rounded-xl border border-slate-200 h-20 object-cover" style="aspect-ratio: 1200 / 630;">
                            <label class="inline-flex items-center gap-2 text-sm text-slate-600">
                                <input type="checkbox" name="remove_featured_image" value="1" class="rounded border-slate-300 text-rose-600 focus:ring-rose-500">
                                Xoá ảnh hiện tại
                            </label>
                        </div>
                    @endif
                    ...
                    @enderror
                    <img id="featured_image_preview" src="" alt="Xem trước ảnh đại diện mới"
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-sm mb-8">
            <div class="border-b border-slate-200/80 rounded-t-2xl px-2 pt-2 bg-slate-50/50 flex overflow-x-auto">
...
<script>
    ...
    // Xem trước ảnh đại diện mới ngay khi người dùng chọn file, trước khi submit
