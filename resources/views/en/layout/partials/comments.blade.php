...
$(document).ready(function () {
    ...
    $(document).on("submit", "#login-form", function (e) {
        ...
        if (name === "") {
            $("#login-error").text("Please type in a name");
            return false;
        }
        ...
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                $("#login-error").text("An error occurred during login. Please try again.");
                ...
                $("#chat-wrapper").html(`
                    <div id="loginform">
                        ...
                        <div id="login-error" class="error">An error occurred during login. Please try again.</div>
                    </div>
                    <div id="chatbox"></div>
                `);
            }
                ...
                if (result) {
                    ...
                    $.ajax({
                        ...
                        error: function (xhr, status, error) {
                            ...
                            $("#login-error").text("An error occurred during logout. Please try again.");
                        }
                    });
                }
            }
