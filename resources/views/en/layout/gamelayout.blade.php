        ...
        <div class="container {{ isset($board) ? 'px-3 pb-0 pt-3' : 'p-3' }}">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mt-lg-0 mt-md-4 mt-sm-4 mt-xs-4">
              @include('en.layout.partials.roomChat')
          ...
          <div class="row">
            <div class="col-12">
              ...
              {{--<div class="dropup mx-auto text-center my-3">
                ...
                <a class="btn btn-dark text-light btn-lg haltPromotion shopee-link" href="https://shopee.vn/tungpham42" target="_blank"><i class="fad fa-shopping-cart"></i> Shop</a>
                <div class="dropdown-menu dropdown-menu-right shadow-lg" aria-labelledby="hostDropdown" id="tao-phong" data-phong="{{ md5(time()) }}" data-url="{{ URL::to('/') }}/room/{{ md5(time()) }}">
                  ...
                  <a data-toggle="tooltip" data-placement="bottom" title="Waiting list" id="room-list" class="drropdown-item ooms-list" style="cursor: pointer !important;" href="{{ URL::to('/rooms') }}"><i class="fas fa-list-alt text-dark"></i> Rooms list</a>
                  @endif
                </div>
              </div> --}}
              @elseif ( $roomCode != '' )
              <p class="w-100 text-center my-3">
                <a class="btn btn-danger text-light btn-lg haltPromotion mx-auto pulse-red rooms-list" href="{{ URL::to('/rooms') }}"><i class="fad fa-chevron-circle-left"></i> Back to room's list</a>
                @include('common.volumeBtn')
                @include('common.tourBtn')
              </p>
              @endif
