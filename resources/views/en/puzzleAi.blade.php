...
<p class="w-100 text-center mt-0 mb-1">
  <a data-step="3" data-intro="Click here to set up a puzzle board" class="w-25 btn btn-dark btn-lg haltPromotion" href="{{ url('/puzzle') }}"><i class="fad fa-puzzle-piece"></i> Setup puzzle</a>
