...
<p class="w-100 text-center mt-0 mb-1">
  <a data-step="3" data-intro="퍼즐 보드를 설정하려면 여기를 클릭하세요" class="w-25 btn btn-dark btn-lg haltPromotion" href="{{ url('/peojeul') }}"><i class="fad fa-puzzle-piece"></i> 퍼즐</a>
...
async function makeBestMove() {
  ...
  $('#game-status').html('생각... <i class="fas fa-spinner fa-spin"></i>');
