...
$(document).ready(function () {
    ...
    $(document).on("submit", "#login-form", function (e) {
        ...
        $("#chat-wrapper").html(`
            <div id="menu">
                <p class="welcome">어서오세요, <b>${name}</b></p>
                <p class="logout"><a id="exit" href="javascript:void(0);">채팅 종료</a></p>
            </div>
            <div id="chatbox"></div>
            <form name="message" id="message-form">
        ...
        $.ajax({
            ...
            error: function (xhr, status, error) {
                ...
                $("#login-error").text("로그인 중 오류가 발생했습니다. 다시 시도하십시오.");
                ...
                $("#chat-wrapper").html(`
                    <div id="loginform">
                        ...
                        <div id="login-error" class="error">로그인 중 오류가 발생했습니다. 다시 시도하십시오.</div>
                    </div>
                    <div id="chatbox"></div>
                `);
            }
                ...
                if (result) {
                    ...
                    $.ajax({
                        ...
                        error: function (xhr, status, error) {
                            ...
                            $("#login-error").text("로그아웃 중 오류가 발생했습니다. 다시 시도하십시오.");
                        }
                    });
                }
            }
