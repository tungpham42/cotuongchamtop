...
<header class="site-header shadow-lg sticky-top">
  <div class="container mx-auto">
    <div class="row align-items-center">
      <a class="navbar-brand small mr-auto my-0 haltPromotion" href="{{ url('/zh') }}"><img src="{{ $cdnUrl }}/img/app-icons/logo.png" class="xiangqi-logo" alt="xiangqi logo"><h1 class="d-inline" style="font-size: inherit !important;"><strong>象棋</strong></h1><span id="header-status"></span></a>
      <div class="menu-toggle open" title="菜单"></div>
      <nav class="navbar py-0">
        <ul class="nav navbar-nav">
          <li>
            <a class="home haltPromotion" href="{{ url('/zh') }}"><i class="far fa-house"></i> 主页</a>
          </li>
          <li>
            <a class="room haltPromotion rooms-list" href="{{ url('/fangjianliebiao') }}"><i class="far fa-list-alt"></i> 房间列表</a>
          </li>
          <li>
            <a class="setup zh haltPromotion" href="{{ url('/mi') }}"><i class="far fa-puzzle-piece"></i> 谜</a>
          </li>
          <li>
            <a class="contact haltPromotion" href="{{ url('/lianxiwomen') }}"><i class="far fa-envelope"></i> 联系我们</a>
          </li>
