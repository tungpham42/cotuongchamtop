        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-header">
                    ...
                    <i class="fas fa-lock-alt"></i> {{ __('Tạo mật khẩu') }}
                    @else
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                @if (url()->current() == url('/tao-mat-khau'))
                                <input data-step="1" data-intro="{{ __('Đây là email hiện tại của bạn') }}" id="email" type="email" class="form-control form-control-lg @error('email') is-invalid @enderror" name="email" value="{{ session('current_email') }}" required readonly autocomplete="email" autofocus>
                                @else
