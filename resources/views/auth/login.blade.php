            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="social-wrapper w-100 d-flex flex-row flex-wrap justify-content-center align-items-center gap-3 mb-4">
                        <a data-step="5"
                           data-intro="{{ __('Đăng nhập ngay lập tức bằng tài khoản Google của bạn') }}"
                           href="{{ url('/auth/google') }}"
                           class="btn btn-google btn-social btn-lg">
                        ...
                        <a data-step="6"
                           data-intro="{{ __('Đăng nhập ngay lập tức bằng tài khoản Facebook của bạn') }}"
                           href="{{ url('/auth/facebook') }}"
                           class="btn btn-facebook btn-social btn-lg">
                    ...
                    <form method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input
                                    data-step="1"
                                    data-intro="{{ __('Điền vào email của bạn') }}"
                                    id="email"
                                    type="email"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input
                                    data-step="2"
                                    data-intro="{{ __('Điền vào mật khẩu') }}"
                                    id="password"
                                    type="password"
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6 offset-md-4">
                                <div
                                    data-step="3"
                                    data-intro="{{ __('Ghi nhớ trạng thái đăng nhập của bạn') }}"
                                    class="form-check"
                                >
                                    <input
                        ...
                        <div class="row mb-0">
                            <div class="col-12">
                                <div class="d-flex flex-wrap justify-content-center align-items-center gap-5 mt-3">
                                    ...
                                    <button
                                        data-step="4"
                                        data-intro="{{ __('Ấn để đăng nhập') }}"
                                        type="submit"
                                        class="btn btn-lg btn-danger mr-2 mb-2"
                                    >
                                    ...
                                    @if (Route::has('password.request'))
                                        <a
                                            ...
                                            href="{{ localized_url('password.request') }}"
                                        >
                                    ...
                                    <a
                                        href="{{ localized_url('register') }}"
                                        class="btn btn-lg btn-success text-light px-4 shadow-sm ml-2 mb-2"
                                    >
