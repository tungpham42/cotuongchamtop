            ...
            <div class="card">
                ...
                <div class="card-body">
                    <p class="w-100 text-center">
                        <a data-step="6" data-intro="{{ __('Đăng ký ngay lập tức bằng tài khoản Google của bạn') }}" href="{{ url('/auth/google') }}" class="mt-0 btn btn-google btn-lg btn-danger mx-auto d-inline-block"><i class="fab fa-google"></i> {{ __('Đăng ký bằng Google') }}</a>
                        ...
                        {{-- <a data-step="6" data-intro="{{ __('Đăng ký ngay lập tức bằng tài khoản Facebook của bạn') }}" href="{{ url('/auth/facebook') }}" class="mt-0 btn btn-facebook btn-lg btn-info mx-auto d-inline-block"><i class="fab fa-facebook-f"></i> {{ __('Đăng ký bằng Facebook') }}</a>
