...
<p class="w-100 text-center">
  ...
  <a data-step="2" data-intro="Ấn vào đây để vào ván đấu khi đến lượt bạn" id="join-link" class="btn btn-danger text-light btn-lg haltPromotion" href="{{ url('/') }}/phong/{{ $roomCode }}" data-toggle="tooltip" data-placement="top" title="Đến lược bạn đi"><i class="fad fa-sign-in-alt"></i> Vào trận</a>
  @elseif (str_contains($room->fen, ' b '))
  <a data-step="2" data-intro="Ấn vào đây để vào ván đấu khi đến lượt bạn" id="join-link" class="btn btn-dark text-light btn-lg haltPromotion" href="{{ url('/') }}/phong/{{ $roomCode }}/khach" data-toggle="tooltip" data-placement="top" title="Đến lược bạn đi"><i class="fad fa-sign-in-alt"></i> Vào trận</a>
  @endif
</p>
@else
