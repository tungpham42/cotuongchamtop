                ...
                <div class="card-body">
                    <form action="{{ route('tournaments.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group text-dark">
                            ...
                            <textarea name="description" class="form-control bg-dark text-dark border-secondary" rows="3"></textarea>
                        </div>

                        <div class="row">
                            <div class="col-md-4 form-group text-dark">
                                <label>{{ __('Ngày Bắt Đầu') }} <span class="text-danger">*</span></label>
                                <input type="datetime-local" name="start_date" class="form-control bg-dark text-dark border-secondary" required>
                            </div>

                            <div class="col-md-4 form-group text-dark">
                                <label>{{ __('Số lượng kỳ thủ') }} <span class="text-danger">*</span></label>
                                <input type="number" name="max_players" class="form-control bg-dark text-dark border-secondary" min="2" max="16" value="16" required>
                            </div>
