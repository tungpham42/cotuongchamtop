                    ...
                    <form action="{{ route('tournaments.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-4 form-group">
                                ...
                                <input type="datetime-local" name="start_date" class="form-control bg-dark text-light border-secondary" required>
                            </div>

                            <div class="col-md-4 form-group">
                                <label>{{ __('Số lượng kỳ thủ') }} <span class="text-danger">*</span></label>
                                <input type="number" name="max_players" class="form-control bg-dark text-light border-secondary" min="2" value="16" required>
                            </div>
                        ...
                        <div class="mt-4 text-right">
                            <a href="{{ route('tournaments.index') }}" class="btn btn-outline-light mr-2">{{ __('Hủy') }}</a>
