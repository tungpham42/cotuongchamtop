...
<div style="background-color: transparent" class="container-fluid userPuzzles puzzles px-0">
    <div class="container mx-auto px-3 pt-0">
        <div id="user-puzzles" class="row my-0">
            <h2 class="d-block w-100 text-light ml-3 mb-4"><i class="fas fa-puzzle-piece"></i> {{ $firstUserPuzzles->total() }} <a class="text-light animate-light showPromotion" href="{{ url('/') }}/tat-ca-the-co">{{ __('thế cờ') }}</a>, <a class="text-light animate-light showPromotion" href="{{ localized_url('puzzle.setup') }}">{{ __('tạo mới ngay') }}</a></h2>
...
@else
    ...
    <div style="background-color: transparent" class="container-fluid userPuzzles puzzles px-0">
        <div class="container mx-auto px-3 pt-0">
            <div id="user-puzzles" class="row my-0">
                <h2 class="d-block w-100 text-light ml-3 mb-4"><i class="fas fa-puzzle-piece"></i> {{ $userPuzzles->total() }} <a class="text-light animate-light showPromotion" href="{{ url('/') }}/tat-ca-the-co">{{ __('thế cờ') }}</a>, <a class="text-light animate-light showPromotion" href="{{ localized_url('puzzle.setup') }}">{{ __('tạo mới ngay') }}</a></h2>
