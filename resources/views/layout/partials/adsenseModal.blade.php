    ...
    <div class="modal-content shadow-lg">
      ...
      <div class="modal-body text-center">
        ...
        <ins class="adsbygoogle"
            ...
            <a class="aff-link" href="https://www.facebook.com/groups/HoiChoiCoTuong" target="_blank" data-toggle="tooltip" data-placement="top" title="{{ __("Diễn đàn") }} {{ __("Cờ tướng") }}"><img alt="{{ __("Diễn đàn") }} {{ __("Cờ tướng") }}" src="{{ asset('img/diendan_cotuong.png') }}"  width="300" height="300" ></a>
        <script>
