  ...
  <div class="container">
    <div class="row py-5 px-0">
      <div class="col-12 col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3 vcard">
        ...
        <p class="mt-3">Bản quyền <i class="fal fa-copyright"></i> {{ date('Y') }} <a class="url fn h-card haltPromotion" target="_blank" href="https://tungpham42.github.io/">Phạm Tùng</a></p>
      ...
      <div class="col-12 col-xl-3 col-lg-3 col-md-6 col-sm-12 mb-3">
        <ul class="list-unstyled">
          <li>
            <a class="home haltPromotion" href="{{ url('') }}"><i class="fal fa-home-lg-alt"></i> Trang chủ</a>
          </li>
          <li>
            <a class="dashboard haltPromotion" href="{{ url('/thi-dau') }}"><i class="fal fa-trophy-alt"></i> Thi đấu</a>
          </li>
          <li>
            <a class="trophy haltPromotion" href="{{ url('/bang-xep-hang') }}"><i class="fal fa-star"></i> Bảng xếp hạng</a>
          </li>
          <li>
            <a class="room haltPromotion rooms-list" href="{{ url('/sanh-cho') }}"><i class="fal fa-list-alt"></i> Sảnh chờ</a>
          </li>
          <li>
            <a class="setup puzzle haltPromotion" href="{{ url('/co-the') }}"><i class="fal fa-puzzle-piece"></i> Cờ thế</a>
          </li>
          <li>
            <a class="about haltPromotion" href="{{ url('/gioi-thieu') }}"><i class="fal fa-info-square"></i> Giới thiệu</a>
          </li>
          <li>
            <a class="contact haltPromotion" href="{{ url('/lien-he') }}"><i class="fal fa-envelope"></i> Liên hệ</a>
          </li>
          <li>
            <a target="_blank" class="game haltPromotion" href="https://game.cotuong.top"><i class="fal fa-gamepad-alt"></i> Trò chơi</a>
          </li>
          <li>
            <a target="_blank" class="chat haltPromotion" href="https://chat.cotuong.top"><i class="fal fa-comment-lines"></i> Chatbox</a>
          </li>
          <li>
            <a target="_blank" class="buy haltPromotion" href="https://www.codester.com/items/41601/multilingual-chinese-chess-game-with-many-options?ref=tungpham"><i class="fal fa-shopping-cart"></i> Mua mã nguồn</a>
          </li>
          <li>
            <a target="_blank" class="2048 haltPromotion" href="https://nhipsinhhoc.vn/"><i class="fal fa-head-side-medical"></i> Nhịp Sinh học</a>
          </li>
          <li>
            <a target="_blank" class="hololab haltPromotion" href="https://hololab.vn/"><i class="fal fa-cube"></i> Hologram</a>
          </li>
          @if (isset($room->host_id))
          <li>
            <a class="lang haltPromotion" href="{{ url('/en') }}"><span class="fi fi-us"></span> English</a>
          </li>
          <li>
            <a class="lang haltPromotion" href="{{ url('/ja') }}"><span class="fi fi-jp"></span> 日本語</a>
          </li>
          <li>
            <a class="lang haltPromotion" href="{{ url('/ko') }}"><span class="fi fi-kr"></span> 한국어</a>
          </li>
          <li>
            <a class="lang haltPromotion" href="{{ url('/zh') }}"><span class="fi fi-cn"></span> 中文</a>
          </li>
          @else
          <li>
          ...
          <li>
            <a class="lang haltPromotion" href="{{ url($langJaUrl) }}"><span class="fi fi-jp"></span> 日本語</a>
          </li>
          <li>
