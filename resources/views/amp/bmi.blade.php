...
<div class="container-fluid about px-0">
  <div class="container p-5">
    <h2 class="h1-responsivefooter text-center my-4">{{ __("Chỉ số khối cơ thể") }}</h2>
    <div class="row">
      <div id="bmi_app" class="mx-auto w-100 shadow-lg rounded">
        ...
        <div class="input-group">
          <div class="input-group-prepend col-4 col-xl-3 col-lg-3 col-md-4 col-sm-4 px-0">
            <span class="input-group-text w-100">{{ __("Cân nặng") }}</span>
          </div>
        ...
        <div class="input-group">
          <div class="input-group-prepend col-4 col-xl-3 col-lg-3 col-md-4 col-sm-4 px-0">
            <span class="input-group-text w-100">{{ __("Chiều cao") }}</span>
          </div>
...
<div class="container-fluid bmi-explanation px-0">
  <div class="container p-5">
    <h2 class="h1-responsivefooter text-center my-4">{{ __("Giải nghĩa") }}</h2>
    <div class="row">
      <p>{{ __("Chỉ số khối cơ thể") }}, cũng gọi là chỉ số thể trọng- thường được biết đến với tên viết tắt BMI theo tên tiếng Anh Body Mass Index, là một cách nhận định cơ thể của một người là gầy hay béo bằng một chỉ số. Chỉ số này do nhà khoa học người Bỉ Adolphe Quetelet đưa ra năm 1832.</p>
      <p>{{ __("Chỉ số khối cơ thể của một người tính bằng trọng lượng (kg) chia cho bình phương chiều cao (đo theo mét hoặc cm). Con số này có thể tính theo công thức trên hoặc chiếu theo bảng tiêu chuẩn.") }}</p>
      <p>{{ __("Chỉ số này có thể giúp xác định một người bị béo phì hay bị suy dinh dưỡng một cách khoa học căn cứ trên số liệu về hình dáng, chiều cao và cân nặng cơ thể.") }}</p>
    </div>
  </div>
</div>
@endsection
