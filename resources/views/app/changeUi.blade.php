                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex flex-column align-items-center justify-content-center bg-light rounded p-4">
                            ...
                            <div id="ui-preview-board" class="shadow-sm" style="width: 100%; max-width: 280px; aspect-ratio: 9/10; position: relative; background-size: 100% 100%; background-repeat: no-repeat; background-position: center; transition: background-image 0.3s ease; border-radius: 4px;">
                                ...
                                <img id="ui-preview-piece-red" alt="Tướng Đỏ" style="position: absolute; bottom: 5%; left: 45%; width: 11%; transform: translateX(-50%); transition: opacity 0.3s ease; filter: drop-shadow(0 2px 3px rgba(0,0,0,0.4));">
                                <img id="ui-preview-piece-black" alt="Tướng Đen" style="position: absolute; top: 5%; left: 45%; width: 11%; transform: translateX(-50%); transition: opacity 0.3s ease; filter: drop-shadow(0 2px 3px rgba(0,0,0,0.4));">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updatePreview() {
            ...
            // Update Board Background (using paths from themeSelector)
            previewBoard.style.backgroundImage = `url('${baseUrl}/img/xiangqiboards/${selectedBoard}.svg')`;

            // Update Pieces (rK = Red King, bK = Black King)
            // Using .svg extension as seen in themeSelector
