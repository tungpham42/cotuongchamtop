...
<p class="w-100 text-center mt-0 mb-1">
  <a data-step="3" data-intro="パズルボードをセットアップするにはここをクリックしてください" class="w-25 btn btn-dark btn-lg haltPromotion" href="{{ url('/pazuru') }}"><i class="fad fa-puzzle-piece"></i> パズル</a>
...
async function makeBestMove() {
  ...
  $('#game-status').html('考え... <i class="fas fa-spinner fa-spin"></i>');
