...
<header class="site-header shadow-lg sticky-top">
  <div class="container mx-auto">
    <div class="row align-items-center">
      <a class="navbar-brand small mr-auto my-0 haltPromotion" href="{{ url('/ja') }}"><img src="{{ $cdnUrl }}/img/app-icons/logo.png" class="xiangqi-logo" alt="xiangqi logo"><h1 class="d-inline" style="font-size: inherit !important;"><strong>シャンチー</strong></h1><span id="header-status"></span></a>
      <div class="menu-toggle open" title="Trình đơn"></div>
      <nav class="navbar py-0">
        <ul class="nav navbar-nav">
          <li>
            <a class="home haltPromotion" href="{{ url('/ja') }}"><i class="far fa-house"></i> ホームページ</a>
          </li>
          <li>
            <a class="room haltPromotion rooms-list" href="{{ url('/heya-ichiran') }}"><i class="far fa-list-alt"></i> 部屋一覧</a>
          </li>
          <li>
            <a class="setup puzzle haltPromotion" href="{{ url('/pazuru') }}"><i class="far fa-puzzle-piece"></i> パズル</a>
          </li>
          <li>
          <a class="contact haltPromotion" href="{{ url('/kontakuto') }}"><i class="far fa-envelope"></i> コンタクト</a>
          </li>
