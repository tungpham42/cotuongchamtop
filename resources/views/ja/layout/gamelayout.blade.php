        ...
        <div class="container {{ isset($board) ? 'px-3 pb-0 pt-3' : 'p-3' }}">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 my-1">
              ...
              @include('ja.layout.partials.themeSelector')
            </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 mt-lg-0 mt-md-4 mt-sm-4 mt-xs-4">
              @include('ja.layout.partials.roomChat')
          ...
          <div class="row">
            <div class="col-12">
              ...
              {{-- <div class="dropup mx-auto text-center my-3">
                ...
                <a class="btn btn-dark text-light btn-lg haltPromotion shopee-link" href="https://shopee.vn/tungpham42" target="_blank"><i class="fad fa-shopping-cart"></i> 店</a>
              ...
              <p class="w-100 text-center my-3">
                <a class="btn btn-danger text-light btn-lg haltPromotion mx-auto pulse-red rooms-list" href="{{ URL::to('/heya-ichiran') }}"><i class="fad fa-chevron-circle-left"></i> 部屋一覧へ戻る</a>
                @include('common.volumeBtn')
                @include('common.tourBtn')
              </p>
              @endif
