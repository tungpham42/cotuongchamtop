(function (window, document) {
    ...
    function convertToXiangqiNotation(move) {
        ...
        function mapFileToColumn(file, isRed) {
            if (typeof file !== "number" || file < 0 || file > 8) {
                return null;
            }
        ...
        if (rankDiff === 0) {
            ...
            directionSymbol = ".";
            target = mapFileToColumn(toPos.file, isRed);
        } else if (fileDiff === 0) {
            // Di chuyển thẳng
        ...
        const fromColumn = mapFileToColumn(fromPos.file, isRed);
