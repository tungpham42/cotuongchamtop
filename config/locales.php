...
return [
    ...
    */
    'paths' => [
        ...
        'tournaments.join' => [
            'vi' => 'giai-dau/{slug}/tham-gia',
            'en' => 'tournaments/{slug}/join',
            'ja' => 'tonamento/{slug}/sanka',
            'ko' => 'toneomeonteu/{slug}/chamga',
            'zh' => 'jinbiaosai/{slug}/jiaru',
        ],
        'tournaments.generate' => [
            'vi' => 'giai-dau/{slug}/tao-bang',
            'en' => 'tournaments/{slug}/generate-bracket',
            'ja' => 'tonamento/{slug}/buraketto-sakusei',
            'ko' => 'toneomeonteu/{slug}/daejinpyo-saengseong',
            'zh' => 'jinbiaosai/{slug}/shengcheng-duizhentu',
        ],
        'tournaments.create' => [
            'vi' => 'admin/giai-dau/tao-moi',
            'en' => 'admin/tournaments/create',
            'ja' => 'admin/tonamento/sakusei',
            'ko' => 'admin/toneomeonteu/mandeulgi',
            'zh' => 'admin/jinbiaosai/chuangjian',
        ],
        'tournaments.store' => [
            'vi' => 'admin/giai-dau',
            'en' => 'admin/tournaments',
            'ja' => 'admin/tonamento',
            'ko' => 'admin/toneomeonteu',
            'zh' => 'admin/jinbiaosai',
        ],
        'tournaments.edit' => [
            'vi' => 'admin/giai-dau/{slug}/sua',
            'en' => 'admin/tournaments/{slug}/edit',
            'ja' => 'admin/tonamento/{slug}/henshuu',
            'ko' => 'admin/toneomeonteu/{slug}/pyeongseong',
            'zh' => 'admin/jinbiaosai/{slug}/bianji',
        ],
        'tournaments.update' => [
            'vi' => 'admin/giai-dau/{slug}',
            'en' => 'admin/tournaments/{slug}',
            'ja' => 'admin/tonamento/{slug}',
